...
_validFunctions = ["bis_fnc_execvm","BIS_fnc_effectKilledAirDestruction","BIS_fnc_effectKilledAirDestructionStage2","BIS_fnc_moduleLightning","bis_fnc_showNotification","BIS_fnc_estimatedTimeLeft"]; //Only these functions can be passed via BIS_fnc_MP
