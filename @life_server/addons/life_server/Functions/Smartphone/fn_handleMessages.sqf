...
switch(_type) do
{
	...
	case 0:
	{
		...
		[[_msg,_player,0],"TON_fnc_clientMessage",_to,false] spawn life_fnc_MP;
	...
	case 1:
	{	
		[[_msg,_player,1],"TON_fnc_clientMessage",west,false] spawn life_fnc_MP;
	};
	//to admins
	case 2:
	{	
		[[_msg,_player,2],"TON_fnc_clientMessage",true,false] spawn life_fnc_MP;
	};
	//ems request
	case 3:
	{	
		[[_msg,_player,5],"TON_fnc_clientMessage",independent,false] spawn life_fnc_MP;
	};
	//adminToPerson
	case 4:
	{
		...
		[[_msg,_player,3],"TON_fnc_clientMessage",_to,false] spawn life_fnc_MP;
	};
	//adminMsgAll
	case 5:
	{
		[[_msg,_player,4],"TON_fnc_clientMessage",true,false] spawn life_fnc_MP;
	};
	//MSGDEP
	case 6:
	{
		[[_msg,_player,6],"TON_fnc_clientMessage",true,false] spawn life_fnc_MP;
	};
};