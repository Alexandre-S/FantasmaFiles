...
_containers = nearestObjects[(getPosATL _house),["Box_IND_Grenades_F_RP","B_supplyCrate_F_RP"],_radius];
{
	// deleteVehicle _x
	[[_x],"life_fnc_delveh",true,false] spawn life_fnc_MP;
} foreach _containers; //Fuck the way you do things Tonic, go fix it
