...
class CfgVehicles
{
        ...
        class UVF_Soldier_Outfit_1: B_Soldier_base_F
	{
                
		scope = 2;
		side = 2;
		displayName = "UVF Soldier (RPG)";
                faction = "UVF";
		...
		author = "Bravo93";
		uniformAccessories[] = {};
                uniformClass = "UVF_Soldier_Outfit_1";
		nakedUniform = "U_BasicBody";
		model = "\A3\Characters_F\Civil\c_hunter_f.p3d";
		Items[] = {};
		// weapons[] = {"arifle_mas_fal","mas_launch_RPG7_F","Throw","Put"};
		// respawnWeapons[] = {"arifle_mas_fal","mas_launch_RPG7_F","Throw","Put"};
		...
		hiddenSelectionsTextures[] = {"\UVF_Pack\Black_Jacket_Open\Uniform1.paa"};  
...
class cfgWeapons
{
	...
	class UVF_Soldier_Outfit_1: Uniform_Base
	{
		scope=public;
                model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver";
		displayName = "Black Jacket (Open)";
		picture = "\UVF_Pack\UI\Jacket2.jpg";
