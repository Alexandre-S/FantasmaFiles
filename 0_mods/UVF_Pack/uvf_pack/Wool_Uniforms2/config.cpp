...
class CfgVehicles
{
        ...
        class UVF_Soldier_Outfit_6: B_Soldier_base_F
	{
                
		scope = 2;
		side = 2;
		displayName = "UVF Soldier (AKM)";
                faction = "UVF";
		...
		author = "Bravo93";
		uniformAccessories[] = {};
                uniformClass = "UVF_Soldier_Outfit_6";
		...
		hiddenSelectionsTextures[] = {"\UVF_Pack\Wool_Uniforms2\Uniform1.paa"};  
...
class cfgWeapons
{
	...
	class UVF_Soldier_Outfit_6: Uniform_Base
	{
		scope=public;
                model = "\A3\Characters_F\Common\Suitpacks\suitpack_blufor_diver";
		displayName = "Woolly Pully (Brown)";
		picture = "\UVF_Pack\UI\Jumper2.jpg";
