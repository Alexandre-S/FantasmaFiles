...
if ( life_cash < 30000 ) exitWith { [[1,"Vous devez payer 30000€ pour envoyer un message"],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP; }; // Hint if person haves no 6000 dollar
