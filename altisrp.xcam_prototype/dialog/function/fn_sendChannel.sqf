...
if ( life_cash < 30000 ) exitWith { [[1,"Vous devez payer 30000â‚¬ pour envoyer un message"],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP; }; // Hint if person haves no 6000 dollar
...
[[1,format ["%1 envoie le message suivant depuis Channel 7: \n\n %2",name player,_message]],"life_fnc_broadcast",true,false] call life_fnc_MP;
[[0,format ["%1 envoie le message suivant depuis Channel 7: %2",name player,_message]],"life_fnc_broadcast",true,false] call life_fnc_MP;
