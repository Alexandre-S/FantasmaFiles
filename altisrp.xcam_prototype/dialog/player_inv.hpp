	...
	class controls {
		...
		*/
		...
		class ButtonMyGang : Life_RscButtonMenu {
			...
			onButtonClick = "if(isNil ""life_action_gangInUse"") then {if(init_gang) then {if(isNil {(group player) getVariable ""gang_owner""}) then {createDialog ""Life_Create_Gang_Diag"";} else {[] spawn life_fnc_gangMenu;};}else{hint ""Initialisation des groupes en cours... patientez 30 sec...""};};";
