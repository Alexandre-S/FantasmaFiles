...
weatherTemplates = [
        ["Clear",[0,0,0,0,1,5],[0.30,0,0,1,1]],
        ["Overcast",[0,0,0,2,5],[0.50,0,0,2,2]],
        ["Light Rain",[0,0,1,1,3,5,5],[0.60,0.3,0.05,3,3]],
        ["Medium Rain",[0,0,1,1,1,2,2,2,4],[0.70,0.5,0.05,4,4]],
        ["Rainstorm",[0,1,2,3,5],[0.80,0.9,0.1,5,5]],
        ["Light Fog",[0,0,0,0,1,2,6],[0.4,0,[0.2,0.01,10],0,0]],
        ["Medium Fog",[0,0,0,5,5,5,7],[0.4,0,[0.4,0.005,20],0,0]],
        ["Dense Fog",[0,1,5,6],[0.5,0,[0.4,0.0025,30],0,0]]
	];
