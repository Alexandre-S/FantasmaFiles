...
(localize "STR_Shop_Veh_UI_Ownership")+ " <t color='#8cff9b'>$%2</t><br/>" +(localize "STR_Shop_Veh_UI_MaxSpeed")+ " %3 km/h<br/>" +(localize "STR_Shop_Veh_UI_HPower")+ " %4<br/>" +(localize "STR_Shop_Veh_UI_PSeats")+ " %5<br/>" +(localize "STR_Shop_Veh_UI_Trunk")+ " %6<br/>" +(localize "STR_Shop_Veh_UI_Fuel")+ " %7<br/>" +(localize "STR_Shop_Veh_UI_Armor")+ " %8",
...
for "_i" from 0 to count(_colorArray)-1 do {
	if((_colorArray select _i) select 1 == (life_veh_shop select 2) OR ((_colorArray select _i) select 1 == "dep" && {(life_veh_shop select 2) == "civ"} && {license_civ_dep}) OR ((_colorArray select _i) select 1 == "vig" && {(life_veh_shop select 2) == "civ"} && {license_civ_vigil}) OR ((_colorArray select _i) select 1 == "gvt" && {(life_veh_shop select 2) == "civ"} && {license_civ_gvt}) OR ((_colorArray select _i) select 1 == "taxi" && {(life_veh_shop select 2) == "civ"} && {license_civ_taxi})) then {
