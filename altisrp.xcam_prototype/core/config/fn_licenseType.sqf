...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "bacpj": {_var = "license_cop_bacpj"}; //BacPJ
			case "medic": {_var = "license_cop_medic"}; //cop medic license cost
			...
			case "thug": {_var = "license_civ_thug"}; //thug License
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_cop_bacpj": {_var = "bacpj"}; //BacPJ
			case "license_cop_medic": {_var = "medic"}; //cop medic license cost
			...
			case "license_civ_thug": {_var = "thug"}; //thug License
