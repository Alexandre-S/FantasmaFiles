...
if(_enable && !life_animals_spawned) then
{
	...
	[] spawn
	{
		...
		_animals = ["Cock_random_F","Cock_random_F","Cock_random_F","Cock_random_F","Cock_random_F","Goat_random_F","Goat_random_F","Goat_random_F","Goat_random_F","Hen_random_F","Hen_random_F","Hen_random_F","Hen_random_F","Hen_random_F","Hen_random_F","Sheep_random_F","Sheep_random_F","Sheep_random_F","Sheep_random_F"]; //Array of animals to spawn
