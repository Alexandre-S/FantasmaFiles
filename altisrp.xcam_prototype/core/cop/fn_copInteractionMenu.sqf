...
if(!(_curTarget getVariable["restrained",false])) then {_Btn1 ctrlEnable false; _Btn4 ctrlEnable false; _Btn5 ctrlEnable false; _Btn6 ctrlEnable false; _Btn7 ctrlEnable false; _Btn8 ctrlEnable false;};
