...
if (count (_unit getVariable ["vehicle_info_owners", []]) < 1 || !(_unit isKindOf "LandVehicle")) exitWith {hint "Vous ne pouvez pas poser de nitro sur ça";};
...
if (_success) then
{
	...
	hint "Nitro monté sur la voiture (3 injections). Appuyez sur - pour activer !";
};