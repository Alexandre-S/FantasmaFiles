...
if(!((_vehicle isKindOf "Land") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship"))) exitWith {};
...
if((_vehicle isKindOf "Land") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	{
		if(!((_vehicle isKindOf "Land") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship"))) exitWith {life_action_inUse = false;};
		_type = getText(configFile >> "CfgVehicles" >> (typeOf _vehicle) >> "displayName");
		switch (true) do
		{
			case (_vehicle isKindOf "Land"): {_price = (call life_impound_car);};
