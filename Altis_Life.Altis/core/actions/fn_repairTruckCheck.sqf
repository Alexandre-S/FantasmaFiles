...
for "_i" from 0 to _hitC do {
	...
	if(_PartN == "hitwindshield_1") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#00D600'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "hitwindshield_1"; _degat > 0 && _degat <= 0.2' ]); };
	if(_PartN == "hitwindshield_2") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#00D600'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "hitwindshield_2"; _degat > 0 && _degat <= 0.2' ]); };
	...
	if(_PartN == "HitLGlass") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#00D600'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "HitLGlass"; _degat > 0 && _degat <= 0.2' ]); };
	...
	if(_PartN == "hitwindshield_1") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#FFFF33'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "hitwindshield_1"; _degat > 0.2 && _degat <= 0.5' ]); };
	if(_PartN == "hitwindshield_2") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#FFFF33'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "hitwindshield_2"; _degat > 0.2 && _degat <= 0.5' ]); };
	...
	if(_PartN == "HitLGlass") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#FFFF33'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "HitLGlass"; _degat > 0.2 && _degat <= 0.5' ]); };
	...
	if(_PartN == "hitwindshield_1") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#FF0000'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "hitwindshield_1"; _degat > 0.5' ]); };
	if(_PartN == "hitwindshield_2") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#FF0000'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "hitwindshield_2"; _degat > 0.5' ]); };
	...
	if(_PartN == "HitLGlass") then { _veh_actions pushback (_vehicle addAction [ format["<t color='#FF0000'>Réparer %1</t>", _PartName], life_fnc_repairTruck, [_PartN,_PartName], 0, false, false, "", '_degat = _target getHitPointDamage "HitLGlass"; _degat > 0.5' ]); };
