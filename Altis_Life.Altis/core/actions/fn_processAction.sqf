...
private["_vendor","_type","_itemInfo","_2var","_oldItem","_oldItem2","_newItem","_cost","_upp","_hasLicense","_itemName","_oldVal","_oldVal2","_ui","_progress","_pgText","_cP","_delayInt","_error1","_error2"];
