...
if(isNil "life_isblacklisted" && _licence == "license_civ_rebel") then {
	exitWith {hint "Vous devez faire une demande sur le forum pour rejoindre une faction terroriste"};
} else{
