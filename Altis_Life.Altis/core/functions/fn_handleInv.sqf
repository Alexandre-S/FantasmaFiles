...
*/
private["_math","_item","_num","_return","_var","_weight","_value","_diff","_resp"];
...
_resp = [_this,3,false,[false]] call BIS_fnc_param; //true = resp; false = no;
...
{
	//Lets add!
	if((life_carryWeight + _weight) <= life_maxWeight || _resp) then
	{
