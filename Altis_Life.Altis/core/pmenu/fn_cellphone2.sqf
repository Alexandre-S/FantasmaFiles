...
<t size='0.90 'font='puristaLight' align='left'>Vous devez avoir votre smartwatch (Montre) pour utiliser le téléphone. Vous pouvez trouver une smartwatch à la superette</t><br/>"];
};
