...
switch (true) do
{
	case ((vehicle player) isKindOf "Man"): {havena_minview = tawvd_foot; havena_maxview=(havena_minview+700);};
	case ((vehicle player) isKindOf "LandVehicle"): {havena_minview = tawvd_car; havena_maxview=(havena_minview+700);};
	case ((vehicle player) isKindOf "Air"): {havena_minview = tawvd_air; havena_maxview=(havena_minview+1000);};
};
