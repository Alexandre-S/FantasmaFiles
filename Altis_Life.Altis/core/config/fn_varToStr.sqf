...
switch (_var) do
{
	...
	case "l_g_airT": {(localize "Pilote Tactique")};
	case "l_g_swat": {(localize "GIGN")};
	case "l_g_swatSnipe": {(localize "GIGN THP")};
	case "l_g_swatBall": {(localize "GIGN Ballistique")};
	case "l_g_swatDrone": {(localize "GIGN Drone Radio")};
	case "l_g_cg": {(localize "STR_License_CG")};
	case "l_g_ctrl": {(localize "Licence Ctrl Aerien")};
