...
switch (playerSide) do
{
	case west:
	{
		life_actions = life_actions + [player addAction["<t color='#00FFFF'>Conduire en tant que gendarme</t>",life_fnc_copEnter,"driver",200,false,false,"",'!isNull cursorTarget && ((cursorTarget isKindOf "Car")||(cursorTarget isKindOf "Air")||(cursorTarget isKindOf "Ship")||(cursorTarget isKindOf "Bicycle")) && (locked cursorTarget) != 0 && cursorTarget distance player < 5']];
