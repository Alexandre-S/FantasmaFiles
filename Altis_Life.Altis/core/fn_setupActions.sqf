...
switch (playerSide) do
{
	case west:
	{
		life_actions = life_actions + [player addAction["<t color='#00FFFF'>Conduire en tant qu'ONU</t>",life_fnc_copEnter,"driver",200,false,false,"",'!isNull cursorTarget && ((cursorTarget isKindOf "Land")||(cursorTarget isKindOf "Air")||(cursorTarget isKindOf "Ship")||(cursorTarget isKindOf "Bicycle")) && (locked cursorTarget) != 0 && cursorTarget distance player < 5']];
		life_actions = life_actions + [player addAction["<t color='#00FFFF'>Monter en tant qu'ONU</t>",life_fnc_copEnter,"passenger",180,false,false,"",'!isNull cursorTarget && ((cursorTarget isKindOf "Land")||(cursorTarget isKindOf "Air")||(cursorTarget isKindOf "Ship")) && (locked cursorTarget) != 0 && cursorTarget distance player < 5']];
		life_actions = life_actions + [player addAction["<t color='#00FFFF'>Commander en tant qu'ONU</t>",life_fnc_copEnter,"commander",180,false,false,"",'!isNull cursorTarget && ((cursorTarget isKindOf "Land")||(cursorTarget isKindOf "Air")||(cursorTarget isKindOf "Ship")) && (locked cursorTarget) != 0 && cursorTarget distance player < 5 && ((cursorTarget isKindOf "sab_UN_Hunter_hmg")||(cursorTarget isKindOf "sab_UN_Offroad_gun")||(cursorTarget isKindOf "sab_UN_Strider")||(cursorTarget isKindOf "sab_UN_Strider_hmg")||(cursorTarget isKindOf "sab_UN_APC")||(cursorTarget isKindOf "sab_UN_CRV")||(cursorTarget isKindOf "sab_UN_Kuma")||(cursorTarget isKindOf "B_Heli_Attack_01_F"))']];
