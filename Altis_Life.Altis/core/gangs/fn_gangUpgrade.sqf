...
if(_action) then {
	...
	[[grpPlayer,"gang_maxMembers",_slotUpgrade,true],"TON_fnc_setObjVar",false,false] spawn life_fnc_MP;
	...
	[[2,grpPlayer,_slotUpgrade],"TON_fnc_updateGang",serverhc,false] spawn life_fnc_MP;
} else {
