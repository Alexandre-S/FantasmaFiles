...
_resourceZones = ["apple_1","apple_2","apple_2_1","apple_3","apple_4","peaches_1","peaches_2","peaches_2_1","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","seigle_1","lead_1","lead_1_1","iron_1","iron_1_1","salt_1","salt_1_1","sand_1","sand_1_1","diamond_1","oil_1","oil_2","rock_1","rye_1","hops_1","yeast_1","mash_1"];
_zone = "";
...
_item = switch(true) do {
	case (_zone in ["apple_1","apple_2","apple_2_1","apple_3","apple_4"]): {"apple"};
	case (_zone in ["peaches_1","peaches_2","peaches_2_1","peaches_3","peaches_4"]): {"peach"};
	case (_zone in ["heroin_1"]): {"heroinu"};
	case (_zone in ["cocaine_1"]): {"cocaine"};
	case (_zone in ["weed_1"]): {"cannabis"};
	case (_zone in ["seigle_1"]): {"seigle"};
	case (_zone in ["lead_1","lead_1_1"]): {"copperore"};
...
while {true} do {
	...
	if(local _vehicle) then {
		_vehicle setFuel (fuel _vehicle)-0.015;
	} else {
		[[_vehicle,(fuel _vehicle)-0.01],"life_fnc_setFuel",_vehicle,false] spawn life_fnc_MP;
	};
