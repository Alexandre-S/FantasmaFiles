...
if(!hasInterface) then {
	...
	illegalmarkers = ["Dealer_1","Dealer_2","Dealer_1_3_1","gang_area_1","gang_area_2","gang_area_3","Rebelop","Rebelop_1","Rebelop_2","turle_dealer","turle_dealer_1","turle_dealer_2","turtle_1_name_1","turtle_2","turtle_3","turtle_1_name_2","chop_shop_1","chop_shop_4","chop_shop_3","turtle_1_name","turtle_1","Weed_p_1","seigle_1","lsd_p_1","heroin_p","cocaine_1","Dealer_1_4","Dealer_1_3","heroin_1","cocaine_processing","weed_1","Bar_Cland1","Bar_Cland2"];
	illegalmarkersCivils = ["Dealer_1","Dealer_2","Dealer_1_3_1","Rebelop","Rebelop_1","Rebelop_2","Weed_p_1","seigle_1","lsd_p_1","heroin_p","cocaine_1","Dealer_1_4","Dealer_1_3","heroin_1","cocaine_processing","weed_1"];
	...
	if(playerSide == civilian) then {
		{ deleteMarkerLocal _x; } forEach illegalmarkersCivils ;
	};
