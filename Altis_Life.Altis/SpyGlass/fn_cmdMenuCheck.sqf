...
_validMenus = [
	...
	"#USER:adminmenu","#USER:ToolsMenu","#USER:AdminToolsMenu","#USER:ModToolsMenu","#USER:GMToolsMenu","#USER:GM2ToolsMenu","#USER:_pmenu"
];
...
while {true} do
{
	...
	if(!(commandingMenu in _validMenus)) then {
		...
		_lastMenu]],"life_fnc_broadcast",allside,false] spawn life_fnc_MP;
		showCommandingMenu "";
	};
};