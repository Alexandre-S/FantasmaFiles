...
"LandRover","bwi_a3_t6","PansyLandRovers","PansyLandRovers","FANTASMA_Units","LT_Characters_S","Medic_uniform_config","giletpolo_uniform_config","blackHunter_uniform_config","LT_Characters_Male_S","Shemaghs","m50gasmask","gasmask","AGM_Armour","AGM_Attach","AGM_Backblast","AGM_Backpacks","AGM_Ballistics","AGM_Captives","AGM_Core","AGM_Difficulties","AGM_FastRoping","AGM_GForces","AGM_Goggles","AGM_Grenades","AGM_Hearing","AGM_Interaction","AGM_Logistics","AGM_MagazineRepack","AGM_Map","AGM_Markers","AGM_Movement","AGM_NightVision","AGM_NoRadio","AGM_Overheating","AGM_Parachute","AGM_Ragdolls","AGM_RealisticNames","AGM_Recoil","AGM_Reload","AGM_SafeMode","AGM_Scopes","AGM_Smallarms","AGM_Thermals","AGM_Vector","AGM_Vehicles","AGM_WeaponSelect","AGM_Wind",
...
"ButtonVideo","ButtonAudio","ButtonControls","ButtonGame","ButtonTutorialHints","ButtonAbort","DebugConsole","Feedback","MessageBox","Version","TraffLight","CBA_CREDITS_CONT_C","CBA_CREDITS_M_P","AGM_Tile","RHS_Options"
];
